    ...
    return (
        <div className="max-w-4xl mx-auto mt-10">
            ...
            <button
                ...
                className="transition ease-in-out hover:-translate-y-1 hover:scale-110 duration:300 m-4 bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-900"
            >
                Agregar Venta
            </button>
            <button
            ...
            <div className="circlePosition bg-teal-600/70 rounded-[100%] blur-[200px] fixed w-[390px] h-[400px]  z-1 translate-y-[60%] translate-x-[20%]"></div>
            <div className="circlePosition bg-blue-600 rounded-[100%] blur-[250px] fixed w-[590px] h-[300px] z-1  translate-y-[80%] translate-x-[-80%]"></div>
